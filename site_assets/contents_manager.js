document.title = "R1DF"  // Just in case
...
// Pages / Sections
const body = document.getElementById("full_body");
...
// Checking for mobile devices (will set to just black image instead of the Albuquerque mall image because it'd be too stretched)
is_mobile = () => {
...
if (is_mobile()) {
    ...
    body.style.backgroundUrl = "none";
    body.style.backgroundColor = "black";
}

// Further toggler functions
show_projects = () => {
